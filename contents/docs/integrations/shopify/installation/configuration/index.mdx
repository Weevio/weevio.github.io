...
Learn more about configuration options in the [Configuration Guide](/docs/integrations/shopify/configuration).
...
- [Explore widget features](/docs/integrations/shopify/features) in detail
- [Review configuration options](/docs/integrations/shopify/configuration) for customization
- [Check configuration examples](/docs/integrations/shopify/configuration/examples) for your business model
- [Set up advanced features](/docs/integrations/shopify/configuration/advanced) like B2B pricing and PunchOut

## Need Help?

If you encounter issues during configuration:

- Review the [Prerequisites Guide](/docs/integrations/shopify/installation/prerequisites) for setup requirements
- Check the [Troubleshooting Guide](/docs/integrations/shopify/troubleshooting) for solutions
