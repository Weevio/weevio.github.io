...
- [ ] Cross-sell associations created in PIMS
...
<Note type="warning">
**Tag Naming:** Use consistent, descriptive tag names. Avoid abbreviations unless they're well-documented. Remember tags are case-sensitive.
</Note>
...
4. Customer has matching tag (case-sensitive)
