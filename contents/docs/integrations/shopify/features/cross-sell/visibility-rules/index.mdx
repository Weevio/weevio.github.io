...
<CardGrid>
  <Card
    ...
    href="/docs/integrations/shopify/features/cross-sell/visibility-rules/tag-reference"
  />
  <Card
    title="Setup Guide"
    description="Step-by-step instructions for tagging products and customers in Shopify admin"
    href="/docs/integrations/shopify/features/cross-sell/visibility-rules/setup"
  />
  <Card
    title="Examples"
    description="Real-world use cases with detailed product and customer tag configurations"
    href="/docs/integrations/shopify/features/cross-sell/visibility-rules/examples"
  />
  <Card
    title="Troubleshooting"
    description="Debug visibility issues, common problems, and tag validation"
    href="/docs/integrations/shopify/features/cross-sell/visibility-rules/troubleshooting"
  />
</CardGrid>
...
1. **New to visibility rules?** Start with the [Setup Guide](/docs/integrations/shopify/features/cross-sell/visibility-rules/setup)
2. **Need tag documentation?** See the [Tag Reference](/docs/integrations/shopify/features/cross-sell/visibility-rules/tag-reference)
3. **Want use case ideas?** Browse [Examples](/docs/integrations/shopify/features/cross-sell/visibility-rules/examples)
4. **Having issues?** Check [Troubleshooting](/docs/integrations/shopify/features/cross-sell/visibility-rules/troubleshooting)
