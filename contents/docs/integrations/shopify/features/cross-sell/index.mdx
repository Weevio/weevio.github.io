...
**Learn more:** See [Product Visibility Rules](/docs/integrations/shopify/features/cross-sell/visibility-rules) for complete documentation on advanced filtering.
...
<CardGrid>
  <Card
    ...
    href="/docs/integrations/shopify/features/cross-sell/visibility-rules"
  />
</CardGrid>
